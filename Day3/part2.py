        ...
        for i in range(int(chunk[1:])):
            ...
            if (x1,y1) in path:
                if (x1,y1) not in points:
                    points[(x1,y1)] = path[(x1,y1)] + count1
    if chunk[0] == 'D':
        for i in range(int(chunk[1:])):
            x1 -= 1
            count1 += 1
